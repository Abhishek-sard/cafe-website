      ...
      <section className="relative w-full h-[400px] flex items-center justify-center text-center text-white overflow-hidden">
        ...
        <div className="relative z-20 max-w-6xl mx-auto px-4">
          ...
          <p className="text-xl md:text-2xl text-amber-200 max-w-3xl mx-auto drop-shadow-md">
            Crafting exceptional coffee experiences since 2010, one cup at a
            time
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-6">
                At Elite Cafe, we believe that great coffee is more than just a
                beverage - it's an experience that brings people together.
                Founded in 2010 by two coffee enthusiasts, Sarah and Michael,
                our journey began with a simple mission: to serve the finest
                coffee while creating a warm, welcoming space for our community.
              </p>
              <p className="text-lg text-gray-700">
                Every bean we source, every cup we brew, and every pastry we
                bake is crafted with attention to detail and a commitment to
                excellence that has made us a beloved destination for coffee
                lovers.
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow-lg text-center">
              ...
              <p className="text-gray-700">
                We partner with ethical farms that practice sustainable
                agriculture and ensure fair wages for coffee growers. Our
                packaging is 100% recyclable and we compost all our coffee
                grounds.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg text-center">
              ...
              <p className="text-gray-700">
                From bean selection to brewing techniques, we never compromise
                on quality. Our baristas are trained to craft each drink with
                precision and passion, ensuring consistency in every cup.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg text-center">
              ...
              <p className="text-gray-700">
                We're more than just a coffee shop - we're a gathering place. We
                support local artists, host community events, and create spaces
                where connections can flourish over great coffee.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-700 text-sm">
                Certified baristas craft each drink with precision, using
                state-of-the-art equipment and traditional methods.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-700 text-sm">
                Every beverage is served at the ideal temperature with attention
                to presentation and customer preference.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <div className="flex flex-col md:flex-row gap-6 items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    With 15 years in the specialty coffee industry, Sarah's
                    expertise in bean selection and roasting has been
                    instrumental in defining our signature flavor profiles. Her
                    passion for sustainable sourcing drives our ethical
                    practices.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <div className="flex flex-col md:flex-row gap-6 items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Michael's background in hospitality and business management
                    ensures that every aspect of Elite Cafe operates seamlessly.
                    He focuses on creating exceptional customer experiences and
      ...
      <section className="py-16 bg-gradient-to-r from-brown-800 to-brown-900 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-amber-600 mb-8 max-w-2xl mx-auto">
            Visit us today and discover why we've been the community's favorite
            coffee destination for over a decade.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/contact"
              className="bg-orange-600 hover:bg-orange-700 text-center text-white px-8 py-3 rounded-full font-semibold transition-all transform hover:scale-105"
            >
              Visit Our Cafe
            </Link>
            <Link
              to="/menu"
              className="border-2 border-orange-600 hover:bg-white hover:text-brown-900 text-center text-amber-600 px-8 py-3 rounded-full font-semibold transition-all"
            >
              View Our Menu
            </Link>
          </div>
